        ...
        $.each(goodsArr, function (index, item) {
          $.each(json, function (ind, obj) {
            if (item.code === obj.code) {
              domStr += "\n                <div class=\"goods-div\">\n                    <input type=\"checkbox\" class=\"one\" > \n                    <img src=\"".concat(obj.imgurl, "\" class=\"goods-img\">\n                    <span class=\"goods-name\" >").concat(obj.title, "</span>\n                    <span class=\"goods-price\">").concat(obj.price, "</span>\n                    <div class=\"goods-am\">\n                        <div class=\"jian\">-</div>\n                        <div class=\"am\">").concat(item.num, "</div>\n                        <div class=\"jia\">+</div>\n                    </div>\n                    <span class=\"goods-prices\"></span>\n                    <div class=\"goods-delete\" code=\"").concat(obj.code, "\">\u5220\u9664</div>\n                </div> ");
              return false;
            }
          });
        });
...
function fn() {
  ...
  gwc_header(); //点击单行的删除 事件委托

  var all = document.querySelector('.all');
  var all2 = document.querySelector('.all2');
  var ones = document.querySelectorAll('.one'); //进入时默认全部选中
  ...
  $('.car-box').click(function (even) {
    var target = even.target; // 点击的是单行的删除时
